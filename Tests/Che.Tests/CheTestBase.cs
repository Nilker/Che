...
namespace Che.Tests
{
    public abstract class CheTestBase : AbpIntegratedTestBase
    {
        protected CheTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<CheApplicationModule>();
            modules.Add<CheDataModule>();
        }

        public void UsingDbContext(Action<CheDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<CheDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<CheDbContext, T> func)
        {
            T result;
