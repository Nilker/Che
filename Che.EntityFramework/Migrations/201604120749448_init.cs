                ...
                c => new
                    {
                        ...
                        TenantId = c.Int(),
                        UserId = c.Long(),
                        ServiceName = c.String(maxLength: 255, storeType: "nvarchar"),
                        MethodName = c.String(maxLength: 255, storeType: "nvarchar"),
                        ...
                        BrowserInfo = c.String(maxLength: 255, storeType: "nvarchar"),
                ...
                c => new
                    {
                        ...
                        EmailAddress = c.String(nullable: false, maxLength: 255, storeType: "nvarchar"),
                ...
                c => new
                    {
                        ...
                        ProviderKey = c.String(nullable: false, maxLength: 255, storeType: "nvarchar"),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AbpUsers", t => t.UserId, cascadeDelete: true)
                .Index(t => t.UserId);
